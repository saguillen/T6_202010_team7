...
public class HashTableSeparateChaining<Key, Value> {
    ...
    private HashTableSeparateChaining<Key, Value>[] st;  // array of linked-list symbol tables
    /**
    ...
    public HashTableSeparateChaining(int m) {
        this.m = m;
        st = (HashTableSeparateChaining<Key, Value>[]) new HashTableSeparateChaining[m];
        for (int i = 0; i < m; i++)
            st[i] = new HashTableSeparateChaining<Key, Value>();
    } 
